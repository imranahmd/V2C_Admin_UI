...
export class ApexchartsComponent implements OnInit {
  ...
  newPiechart() {debugger
    ...
    Object.keys(riskflag).forEach(element => {
      labelsarray.push( this.toTitleCase(element))
    ...
    this.chartOptions = {
      ...
      chart: {
        ...
        events: {
          ...
          // },
          dataPointSelection: (e: any, chart: any, opts: any) => {debugger
  ...
  public updateQuarterChart(sourceChart: any, destChartIDToUpdate: any) {debugger
    ...
    if (sourceChart.w.globals.selectedDataPoints[0]) {
      ...
      for (var i = 0; i < selectedPoints[seriesIndex].length; i++) {
        ...
        this.getdownload(`${API_URL}/getRiskCountData/`, merchantdata).subscribe((res: any) => {
          ...
          // });
          this.titletext = {
            text: this.toTitleCase(this.IndexColor),
            offsetX: 10
          }
          this.series.push({
            name: "Risk Code",
 ...
 toTitleCase(str:any) {
  ...
  newBarChart(IndexColor: any) {debugger
