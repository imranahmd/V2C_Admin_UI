...
export class RefundManagementService {
  ...
  getServiceProviderList(data:any)
  {  return this.apiHttpService
    .post(
      `${API_URL}/GetDropdown/`,data
    )
  ...
  getRefundRequestStatus(data:any)
  {
    return this.apiHttpService
    .post(
      `${API_URL}/RefundRequestStatus/`,data
    )

  }
  getDownloadManualRefundFile(data:any)
  {
    return this.apiHttpService
    .post(
      `${API_URL}/DownloadManual-RefundFile/`,data
    )
  ...
  DownloadManualRefundFileFrom(data:any)
  {
    return this.apiHttpService
    .post(
      `${API_URL}/DownloadManual-RefundFileFromList/`,data
    )

  }

  uploadManualRefundFile(data:any)
  {
    return this.apiHttpService
    .post(
      `${API_URL}/Upload-ManualRefundFile/`,data
    )

  }

  uploadAtomRefundFile(data:any)
  {
    return this.apiHttpService
    .post(
      `${API_URL}/AtomRefund-FromFile/`,data
    )
