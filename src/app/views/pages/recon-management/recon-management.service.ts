...
export class ReconManagementService {
// @ts-ignore
...
getReconConfigList(data:any){
  return this.apiHttpService
  .post(`${API_URL}/getReconConfigList`,
    data)
}
...
getreport(data:any) {
  return this.apiHttpService
    .post(
      `${API_URL}/getReconExceptionReport`,data
...
getReconExceptionReportReconRefund(data:any)
{
  return this.apiHttpService
  .post(
    `${API_URL}/getReconExceptionReportReconRefund/`, data
  );
}

getForceReconExceptionReportFinal(data:any)
{
  return this.apiHttpService
  .post(
    `${API_URL}/getForceReconExceptionReportFinal/`, data
  );
}


deleteReconConfig(data:any){
  return this.apiHttpService
  .post(
    `${API_URL}/deleteReconConfig/`, data
  );

}


uploadMPRfile(data:any)
{
  return this.apiHttpService
  .post(
    `${API_URL}/uploadMPRfile/`, data
  );
}

readwritempr(data:any)
{
  return this.apiHttpService
  .post(
    `${API_URL}/readwritempr/`, data
  );
}

emailtriggering(data:any)
{
  return this.apiHttpService
  .post(
    `${API_URL}/emailtriggering/`, data
  );
}
