...
@Component({
  selector: 'app-recharge-list-view',
  templateUrl: './recharge-list-view.component.html',
  styleUrls: ['./recharge-list-view.component.scss']
})
export class RechargeListViewComponent implements OnInit {
  ...
  ID: any;
  getbankdata: any;
  constructor(private fb: FormBuilder, private masterservice: RechargeManagementService, private alertService: AlertService,) {
    debugger
  ...
  onGenerate(formvalue: any, status: any) {
    ...
    setTimeout(() => {
      if (this.serviceForm.valid) {
        ...
        this.masterservice.Approve(merchantdata).subscribe((res: any) => {
