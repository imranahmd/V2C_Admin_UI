...
@Component({
  selector: 'app-life-cycle-bulk-upload',
  templateUrl: './life-cycle-bulk-upload.component.html',
  styleUrls: ['./life-cycle-bulk-upload.component.scss']
})
export class LifeCycleBulkUploadComponent implements OnInit {
