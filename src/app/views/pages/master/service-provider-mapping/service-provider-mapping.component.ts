...
@Component({
  selector: 'app-service-provider-mapping',
  templateUrl: './service-provider-mapping.component.html',
  styleUrls: ['./service-provider-mapping.component.scss']
})
export class ServiceProviderMappingComponent implements OnInit {
