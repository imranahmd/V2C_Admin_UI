...
// this.merchantBasic.controls['PartnerBy'].setValue('0')
  }
      ...
      .subscribe((data) => (this.datafield = data,
        ...
        this.datafield.length > 0 ?
          this.merchantBasic.patchValue({
            ...
            Static:data[0].static_QR == "1" ? true : false,
            Dynamic:data[0].dynamic_QR == "1" ? true : false,
            upi: data[0].upi_loader,
            PartnerBy:data[0].partnerBy||'0'
    ...
    setTimeout(() => {
      ...
      if (this.merchantBasic.valid) {
        ...
        var body = {
          ...
          "static_QR": this.merchantBasic.value.Static ? "1" : "0" || "",
          "dynamic_QR": this.merchantBasic.value.Dynamic ? "1" : "0" || "",
          "partnerBy":data.PartnerBy||'0'
        ...
        // var body={
        //   "merReturnUrl": "http://54.90.122.218:8080/PayidVAS/merchantResponse.jsp,https://Payidpgtest.in/PayidVAS/merchantResponse.jsp,http://localhost:8082/PayidVAS/merchantResponse.jsp,https://Payidpgtest.in/PayidVASPAY/merchantResponse.jsp",
        //         "isAutoRefund": "0",
        //         "hours": "01",
        //         "minutes": "05",
        //         "isPushUrl": "0",
