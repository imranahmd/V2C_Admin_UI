...
export class MerchantCreationComponent implements OnInit {
  ...
  constructor(private router: Router, private menuService: MenusService, private location: Location, private route: ActivatedRoute, private sidebarComponent: SidebarComponent, private sideNavService: SideNavService) {
  }
  ...
  ngOnInit(): void {
    ...
    const structMenu = this.menuService.structuredMenu(r, rawList.PMenuId);
    ...
    // console.log("side---------->",this.sidebarComponent.sideNavService.toggle(event))
