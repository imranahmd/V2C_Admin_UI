...
import { PayoutMdrComponent } from '../payout-mdr/payout-mdr.component';
import { UserIDBaseAccessComponent } from '../user-idbase-access/user-idbase-access.component';
...
const routes: Routes = [
  {
    ...
    children: [
      ...
      {
        path: 'payout-mdr',
        component: PayoutMdrComponent 
      },
      {
        path: 'merchant-Menumapping',
        component: UserIDBaseAccessComponent 
      }
    ]
  }
]
