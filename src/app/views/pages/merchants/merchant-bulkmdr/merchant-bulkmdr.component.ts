...
export class MerchantBulkmdrComponent implements OnInit {
  ...
  public exportAsExcelFile(json: any[], excelFileName: string): void {debugger
  ...
  private saveAsExcelFile(buffer: any, fileName: string): void {debugger
