...
@Component({
  selector: 'app-replicate-merchant-mdr',
  templateUrl: './replicate-merchant-mdr.component.html',
  styleUrls: ['./replicate-merchant-mdr.component.scss']
})
export class ReplicateMerchantMDRComponent implements OnInit {
  ...
  onSubmit(formvalue: any) {
    ...
    // }
    // if (this.transactionListFilter.controls['lifecyclestatus'].invalid) {
    ...
    if (this.transactionListSubmitForm.valid) {
      ...
      this.array.forEach(element => {
        data.push({
          ...
          "rrnStatus": formData.lifecyclestatuss,
