...
export class DynamicreportService {
  ...
  getChargebackReportData(data: any) {
    return this.services
      .post(
        `${API_URL}/getChargebackReportData/`, data
      )
  }

  getStatusReportData(data: any) {
    return this.services
      .post(
        `${API_URL}/getTOFTxnList/`, data
      )
  }

  updateStatusReportData(data: any) {
    return this.services
      .post(
        `${API_URL}/updateTOFList/`, data
      )
  }
}
