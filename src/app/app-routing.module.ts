  ...
  },
  {
    ...
    children: [
      ...
      
      {
        path: 'performance',
        canActivate: [AuthGuard],
        data: { breadcrumb: {alias: 'Performance'} },
        loadChildren: () => import('./views/pages/performance/performance.module').then(m => m.PerformanceModule)
      },
      {
        path: 'rechargemanagement',
        canActivate: [AuthGuard],
        data: { breadcrumb: {alias: 'Performance'} },
        loadChildren: () => import('./views/pages/recharge-management/recharge-management.module').then(m => m.RechargeManagementModule)
      },
